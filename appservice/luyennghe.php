...
<!--                    <audio src="--><?php //echo $question['medialink']?><!--" controls></audio>-->
<!--                </div>-->
            ...
            <div class="center luachon" style="display: none">
                ...
                <?php if(count($nextquestion['_id'])>0){ ?>
                <a class="ht" href="?id=<?php echo $obj['_id'] ?>&nextid=<?php echo $nextquestion['_id']?>">Bài tiếp</a>
                <?php } ?>
                <?php if(count($nextquestion['_id'])<=0){ ?>
                <a class="ht" href="?id=<?php echo $obj['_id'] ?>">Quay lại từ đầu</a>
                <?php } ?>
            </div>
        </div>
    </div>
