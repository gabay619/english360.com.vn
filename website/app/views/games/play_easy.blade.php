            ...
            <div class="block_game block">
                ...
                <div class="middle_body_game block">
                    ...
                    <div class="playing_game_screen block">
                        ...
                        <div class="list_answer_game block center hover" style="display: none" data-id="{{$key}}">
                            @if(isset($aQuestion['select']))
                            @foreach($aQuestion['select'] as $aSelect)
                            {{--<a href="" class="btn_game btn_game_4 select">Đáp án được chọn</a>--}}
                            <a href="javascript:void(0)" class="btn_game btn_game_3 btn_answer">{{$aSelect}}</a>
                            @endforeach
                            @endif
                        </div>
                        @endforeach
