    ...
    <div class="content_left">
        <div class="block">
            <div class="heading_cate">
                <h2><strong>Ngữ âm</strong><label class="label_heading_cate"></label></h2>
                <ul class="list_heading_cate">
                    @foreach($allLnaCategories as $aCate)
                        <li><a href="{{LuyenNguAm::getCateUrl($aCate)}}" title="">{{$aCate->name}}</a></li>
                    @endforeach
                </ul>
            </div>
                ...
                <div class="highlight_left">
                    <ul class="bxslider">
                        @foreach($slide as $aSlide)
                            <li>
                                <div class="item1">
                                    <a href="{{LuyenNguAm::getStaticDetailUrl($aSlide['name'], $aSlide['_id'])}}">
                ...
                <div class="highlight_right">
                    <ul class="list_highlight_right">
                        @foreach($hightlight as $item)
                            <li>
                                <div class="item1">
                                    <a href="{{LuyenNguAm::getStaticDetailUrl($item['name'], $item['_id'])}}">
