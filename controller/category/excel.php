...
require_once dirname(__FILE__) . '/plugin/Classes/PHPExcel/IOFactory.php';
...
$objPHPExcel = PHPExcel_IOFactory::load("Từ điển tiếng anh chuyên ngành công nghệ thông tin(1).xls");
