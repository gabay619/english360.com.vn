(function (e) {
    ...
    var c = {
        ...
        isArray: Array.isArray || function (f) {return Object.prototype.toString.call(f) === "[object Array]"},
...
(function (f, e) {
    ...
    e.adapter = {
        patchEditor: function (j) {
            ...
            function g(m, n) {
                ...
                if (b.test(m)) {
                    if (n !== c) {
                        l.each(function (o, p) {j.dom.setAttrib(p, m, n)});
                        return l
                    } else {
            ...
            function k(l) {
                if (l.css !== h) {
                    ...
                    l.attr = g;
                    l.tinymce = j;
                    l.pushStack = function () {return k(i.pushStack.apply(this, arguments))}
                }
                return l
            }
    ...
    e.extend(e, {
        map: f.map,
        grep: function (g, h) {return f.grep(g, h || function () {return 1})},
        inArray: function (g, h) {return f.inArray(h, g || [])}
    });
    var a = {
        "tinymce.dom.DOMUtils": {
            ...
            }, is: function (h, g) {return f(this.get(h)).is(g)}
        }
    };
    e.onCreate = function (g, i, h) {e.extend(h, a[i])}
...
(function (a) {
    a.VK = {
        ...
        TAB: 9,
        UP: 38,
        modifierPressed: function (b) {return b.shiftKey || b.ctrlKey || b.altKey},
        metaKeyPressed: function (b) {return a.isMac ? b.metaKey : b.ctrlKey && !b.altKey}
    }
})(tinymce);
tinymce.util.Quirks = function (a) {
    ...
    function z(L) {return L.isDefaultPrevented()}
    ...
    function J() {
        function L(O) {
            ...
            E(e.select("span", Q), function (R) {R.setAttribute("data-mce-mark", "1")});
        ...
        a.addCommand("Delete", function () {L()})
    }
    ...
    function K() {
        if (!a.settings.content_editable) {
            e.bind(a.getDoc(), "focusin", function (L) {l.setRng(l.getRng())});
        ...
        function M() {
            ...
            return function () {
                ...
                if (P !== a.getBody()) {
                    ...
                    E(O, function (Q) {P.setAttributeNode(Q.cloneNode(true))})
                }
            }
        }

        function L() {return !l.isCollapsed() && e.getParent(l.getStart(), e.isBlock) != e.getParent(l.getEnd(), e.isBlock)}
    ...
    function x() {document.body.setAttribute("role", "application")}
    ...
    function m() {
        if (H.forced_root_block) {
            a.onInit.add(function () {A("DefaultParagraphSeparator", H.forced_root_block)})
        }
    }
    ...
    function r() {
        ...
        if (n() >= 10) {
            L = "";
            E("p div h1 h2 h3 h4 h5 h6".split(" "), function (M, N) {L += (N > 0 ? "," : "") + M + ":empty"});
    ...
    function u() {
        ...
        function U() {
            ...
            E(e.select("img[data-mce-selected]"), function (ag) {ag.removeAttribute("data-mce-selected")});
            if (af) {
                Q(af)
            } else {
                S()
...
(function (f) {
    ...
    f.html.Schema = function (A) {
        ...
        u.getTextBlockElements = function () {return textBlockElementsMap};
...
(function (e) {
    ...
    e.create("tinymce.ui.NativeListBox:tinymce.ui.ListBox", {
        ...
        }, isDisabled: function () {return d.get(this.id).disabled}, select: function (h) {
            var g = this, j, i;
            if (h == c) {
                return g.selectByIndex(-1)
            }
...
(function (a) {
    a.Formatter = function (aa) {
        ...
        function I(ab) {return !!aa.schema.getTextBlocks()[ab.toLowerCase()]}
        ...
        function j() {
            l({
                ...
                link: {
                    ...
                    split: true,
                    deep: true,
                    onmatch: function (ab) {return true},
                    onformat: function (ad, ab, ac) {T(ac, function (af, ae) {c.setAttrib(ad, ae, af)})}
                },
                removeformat: [{
        ...
        function p(ab, am, ae) {
            ...
            function ao(aA) {
                ...
                at = c.getRoot();
                function ay(aB) {return aB.nodeName == "BR" && aB.getAttribute("data-mce-bogus") && !aB.nextSibling}
...
tinymce.onAddEditor.add(function (e, a) {
    ...
    if (c.inline_styles) {
        ...
        d = {
            ...
            u: function (j, i) {b(i, {textDecoration: "underline"})},
            strike: function (j, i) {b(i, {textDecoration: "line-through"})}
        };
