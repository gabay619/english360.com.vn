...
$lnaParentCate = $categorycl->findOne(array('type'=>Constant::TYPE_LUYENNGUAM, 'parentid'=>'0'));
$id = $_GET['id'];
?>
...
##Get Data
if ($tact != "luyennguam_insert") $_POST = (array)$newscl->findOne(array("_id" => "$id"));
else{
...
<form class="form-horizontal" role="form" action="" method="post">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" id="category">
            ...
            dequy("0", Constant::TYPE_LUYENNGUAM);
