<?php
$title = "Thông tin bài tập điền chữ - luyện ngữ âm";
...
<div class="text-left"><a href="<?php echo cpagerparm("tact,id") ?>tact=lna_dc_view ">Trở về danh sách bài tập</a></div>
...
##Get Data
if ($tact != "lna_dc_insert") $_POST = (array)$newscl->findOne(array("_id" => "$id"));
?>
<form class="form-horizontal" role="form" action="" method="post">
    <ul class="nav nav-tabs" role="tablist" id="myTab">
        <li class="active"><a href="#info" role="tab" data-toggle="tab">Thông tin bài tập điền chữ</a></li>
    </ul>
...
<!--            </div>-->
            ...
            <div class="listaw">
                ...
                foreach($_POST['question'] as $key=>$item){
                    ...
                    <div class="form-group" data-order="<?php echo $key?>">
                        ...
                        <div class="col-sm-3">
                            <input type="text" placeholder="Đáp án" name="question[<?php echo $key?>][aw]" class="form-control" value="<?php echo $item['aw'] ?>">
                        </div>
                        <div class="col-sm-3">
                            <input type="text" placeholder="Từ thiếu (dùng dấu _ với chữ cái thiếu)" name="question[<?php echo $key?>][short]" class="form-control" value="<?php echo $item['short'] ?>">
                        </div>
                        <div class="col-sm-3">
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            ...
            hoặc <a href="<?php echo cpagerparm("tact,id") ?>tact=lna_dc_view">Thoát</a> |
...
//        console.log(lastOrder);return false;
        html = '<div class="form-group" data-order="'+next+'">'+
                ...
                '<div class="col-sm-3">'+
                '<input type="text" placeholder="Đáp án" name="question['+next+'][aw]" class="form-control">'+
                '</div>'+
                '<div class="col-sm-3">'+
                '<input type="text" placeholder="Từ thiếu (dùng dấu _ với chữ cái thiếu)" name="question['+next+'][short]" class="form-control">'+
                '</div>'+
                '<div class="col-sm-3">'+
