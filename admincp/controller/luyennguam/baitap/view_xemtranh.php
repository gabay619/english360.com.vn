<?php
$title = "Quản lý bài tập nghe xem tranh - luyện ngữ âm";
...
$type = array('lnaid'=>$lnaid,'type'=>'lna_xemtranh');
$cond['lnaid'] = $lnaid;
$cond['type'] = $type;
$sort = array("_id" => -1);
...
<div class="text-right row">
    <div class="col-xs-3 text-left">
        ...
        <?php if(acceptpermiss("luyennguam_test_insert")) { ?><a href="<?php echo cpagerparm("tact,id,status") ?>tact=lna_xt_insert">Thêm bài tập xem tranh</a><?php }?>
    </div>
    ...
    <table class="table table-hover">
        ...
        <?php foreach ($listnews as $item) { ?>
            <tr>
                ...
                <td>
                    <?php if(acceptpermiss("luyennguam_test_update")) { ?><a href="<?php echo cpagerparm("tact,status,id") ?>tact=lna_xt_update&id=<?php echo $item['_id'] ?>">Sửa</a> |<?php }?>
