...
<div class="text-left"><a href="<?php echo cpagerparm("tact,id") ?>tact=lna_dt_view ">Trở về danh sách bài tập</a></div>
...
##Get Data
if ($tact != "lna_dt_insert") $_POST = (array)$newscl->findOne(array("_id" => "$id"));
?>
<form class="form-horizontal" role="form" action="" method="post">
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            ...
            hoặc <a href="<?php echo cpagerparm("tact,id") ?>tact=lna_dt_view">Thoát</a> |
