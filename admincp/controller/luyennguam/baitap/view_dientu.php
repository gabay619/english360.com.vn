<?php
$title = "Quản lý bài tập nghe điền từ - luyện ngữ âm";
...
$type = array('lnaid'=>$lnaid,'type'=>'lna_dientu');
$cond['lnaid'] = $lnaid;
$cond['type'] = $type;
$sort = array("_id" => -1);
...
<div class="text-right row">
    <div class="col-xs-3 text-left">
        ...
        <?php if(acceptpermiss("luyennguam_test_insert")) { ?><a href="<?php echo cpagerparm("tact,id,status") ?>tact=lna_dt_insert"> | Thêm bài tập điền từ</a><?php }?>
    </div>
    ...
    <table class="table table-hover">
        ...
        <?php foreach ($listnews as $item) { ?>
            <tr>
                ...
                <td>
                    <?php if(acceptpermiss("luyennguam_test_update")) { ?><a href="<?php echo cpagerparm("tact,status,id") ?>tact=lna_dt_update&id=<?php echo $item['_id'] ?>">Sửa</a> |<?php }?>
