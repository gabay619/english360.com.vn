<?php
$location_page = array('name' => 'Bài học miễn phí', 'type' => 'free_lession');
                ...
                foreach ($list as $item) {
                    ...
                    switch($item['type']){
                        ...
                        case Constant::TYPE_SONG:
                            $itemCl = $dbmg->hmcaudio;
                            break;
                        case Constant::TYPE_LUYENNGUAM:
                            $itemCl = $dbmg->luyennguam;
                            break;
                        default:
                            $itemCl = $dbmg->thuvien;
                            break;
...
<script>
    ...
    function saveData() {
        ...
        if(list_lession.length > 0){
            $.post("incoming.php", { act: 'savetofreelession', lession:list_lession}, function (re) {
                if(re.status == 200){
