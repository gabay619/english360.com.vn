...
if(!empty($_GET['response_code'])){
    if($_GET['response_code'] == '1') {
        $cond['response_code'] = Constant::TXN_OTP_SUCCESS;
    }else{
        $cond['response_code'] = array('$nin'=>array(Constant::TXN_OTP_SUCCESS));
    }
...
<script>
    function getLog(id) {
        $.post('incoming.php?act=getLogOtp', {
            id:id
        }, function (re) {
