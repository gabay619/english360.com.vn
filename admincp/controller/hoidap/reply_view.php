...
$sort = array("_id" => -1);
$cursor = $newscl->find(array("parentid"=>$id))->sort($sort);
        ...
        <table class="table table-hover">
            ...
            <?php foreach ($listnews as $item) {
                ...
                <tr>
                    ...
                    <td>
                        <?php if(acceptpermiss("hoidap_update")) { ?><a href="<?php echo cpagerparm("tact,status,id") ?>tact=reply_update&id=<?php echo $item['_id'] ?>">Sửa</a> |<?php }?>
