<?php
$title = "Thông tin bài tập ọhọn từ - ngữ pháp";
...
<div class="text-left"><a href="<?php echo cpagerparm("tact,id") ?>tact=np_ct_view ">Trở về danh sách bài tập</a></div>
...
##Get Data
if ($tact != "np_ct_insert") $_POST = (array)$newscl->findOne(array("_id" => "$id"));
?>
<form class="form-horizontal" role="form" action="" method="post">
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="info">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label">Các từ cho sẵn</label>
                <div class="col-sm-10">
            ...
            <div class="listaw">
                ...
                foreach($_POST['question'] as $key=>$item){
                    ...
                    <div class="form-group" data-order="<?php echo $key?>">
                        ...
                        <div class="col-sm-3">
                            <input type="text" placeholder="Từ cần điền, cách nhau bởi dấu |" name="question[<?php echo $key?>][word]" class="form-control" value="<?php echo $item['word'] ?>">
                        </div>
                        <div class="col-sm-3">
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            ...
            hoặc <a href="<?php echo cpagerparm("tact,id") ?>tact=np_ct_view">Thoát</a> |
...
<div>
    ...
    <img src="/admincp/asset/images/nguphap/nguphap_chontu.png" alt="" style="display: none; border: 1px dashed #ccc" >
</div>
<script>
    $(function () {
