<?php
$title = "Thông tin bài tập điền từ - ngữ pháp";
...
<div class="text-left"><a href="<?php echo cpagerparm("tact,id") ?>tact=np_dt_view ">Trở về danh sách bài tập</a></div>
...
##Get Data
if ($tact != "np_dt_insert") $_POST = (array)$newscl->findOne(array("_id" => "$id"));
?>
<form class="form-horizontal" role="form" action="" method="post">
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            ...
            hoặc <a href="<?php echo cpagerparm("tact,id") ?>tact=np_dt_view">Thoát</a> |
...
<div>
    ...
    <img src="/admincp/asset/images/nguphap/nguphap_dientu.png" alt="" style="display: none; border: 1px dashed #ccc" >
</div>
<script>
