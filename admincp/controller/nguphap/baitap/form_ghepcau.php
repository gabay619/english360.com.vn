<?php
$title = "Thông tin bài tập ghép câu - ngữ pháp";
...
<div class="text-left"><a href="<?php echo cpagerparm("tact,id") ?>tact=np_gc_view ">Trở về danh sách bài tập</a></div>
...
##Get Data
if ($tact != "np_gc_insert") $_POST = (array)$newscl->findOne(array("_id" => "$id"));
?>
<form class="form-horizontal" role="form" action="" method="post">
    <ul class="nav nav-tabs" role="tablist" id="myTab">
        <li class="active"><a href="#info" role="tab" data-toggle="tab">Thông tin bài tập ghép câu</a></li>
    </ul>
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="info">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <a href="javascript:void(0)" onclick="addQuestion()">Thêm câu</a>
                </div>
            </div>
            <div class="listaw">
                <div class="form-group">
                    ...
                    foreach ($_POST['aw'] as $key=>$item){
                        ?>
                        <label class="col-sm-2 control-label txtaw">Câu thứ <?php echo $key+1 ?></label>
                        <div class="col-sm-2">
                            <input type="text" name="audio[]" class="form-control" value="<?php echo $_POST['audio'][$i] ?>" placeholder="Audio">
                        </div>
                        <div class="col-sm-3">
                            <input type="text" name="aw[]" class="form-control" value="<?php echo $_POST['aw'][$i] ?>" placeholder="<?php echo $key+1 ?>">
                        </div>
                        <div class="col-sm-3">
                            <input type="text" name="ax[]" class="form-control" value="<?php echo $_POST['ax'][$i] ?>" placeholder="<?php echo Common::numtoalpha($key) ?>">
                        </div>

                        <div class="col-sm-1">
                            <input type="text" name="true[]" class="form-control" value="<?php echo $_POST['true'][$i]?>" placeholder="Đáp án">
                        </div>
...
<div>
    ...
    <img src="/admincp/asset/images/nguphap/nguphap_ghepcau.png" alt="" style="display: none; border: 1px dashed #ccc" >
</div>
<div class="template" style="display: none">
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <input type="text" name="ax[]" class="form-control">
        </div>
        <div class="col-sm-1">
            <input type="text" name="true[]" class="form-control" placeholder="Đáp án">
        </div>
        <div class="col-sm-1">
...
//        console.log(lastOrder);return false;
    ...
    function reindexlabel(){
        ...
        $.each(a,function(i,v){
            ...
            $(this).parent().find('input[name="aw[]"]').attr('placeholder',i+1);
            $(this).parent().find('input[name="ax[]"]').attr('placeholder',numtoalpha(i));
        })
    }
