<?php
$title = "Thông tin bài tập trắc nghiệm theo tranh - ngữ pháp";
...
<div class="text-left"><a href="<?php echo cpagerparm("tact,id") ?>tact=np_tnt_view ">Trở về danh sách bài tập</a></div>
...
##Get Data
if ($tact != "np_tnt_insert") $_POST = (array)$newscl->findOne(array("_id" => "$id"));
?>
<form class="form-horizontal" role="form" action="" method="post">
    <ul class="nav nav-tabs" role="tablist" id="myTab">
        <li class="active"><a href="#info" role="tab" data-toggle="tab">Thông tin bài tập trắc nghiệm theo tranh</a></li>
    </ul>
        ...
        <div class="tab-pane active" id="info">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <p class="help-block">Upload file audio và ảnh trên /fm rồi paste link vào ô</p>
                </div>
            </div>
            <div class="listaw">
                <?php
                foreach($_POST['question'] as $key=>$item){
                    ...
                    <div class="form-group" data-order="<?php echo $key?>">
                        ...
                        <div class="col-sm-4">
                            <input type="text" placeholder="Số thứ tự ĐA đúng, cách nhau bởi |" name="question[<?php echo $key?>][aw]" class="form-control" value="<?php echo $item['aw'] ?>">
                        </div>
                    </div>
                <?php } ?>
            </div>
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            ...
            hoặc <a href="<?php echo cpagerparm("tact,id") ?>tact=np_tnt_view">Thoát</a> |
...
<div>
    ...
    <img src="/admincp/asset/images/nguphap/nguphap_tracnghiemtranh.png" alt="" style="display: none; border: 1px dashed #ccc" >
</div>
<script>
...
//        console.log(lastOrder);return false;
        html = '<div class="form-group" data-order="'+next+'">'+
            ...
            '</div>'+
            '<div class="col-sm-4">'+
            '<input type="text" placeholder="Số thứ tự ĐA đúng, cách nhau bởi |" name="question['+next+'][aw]" class="form-control">'+
            '</div>'+
            '<div class="col-sm-1">'+
