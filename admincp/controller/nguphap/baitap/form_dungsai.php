<?php
$title = "Thông tin bài tập đúng sai - ngữ pháp";
...
<div class="text-left"><a href="<?php echo cpagerparm("tact,id") ?>tact=np_ds_view ">Trở về danh sách bài tập</a></div>
...
##Get Data
if ($tact != "np_ds_insert") $_POST = (array)$newscl->findOne(array("_id" => "$id"));
?>
<form class="form-horizontal" role="form" action="" method="post">
    <ul class="nav nav-tabs" role="tablist" id="myTab">
        <li class="active"><a href="#info" role="tab" data-toggle="tab">Thông tin bài tập đúng - sai</a></li>
    </ul>
        ...
        <div class="tab-pane active" id="info">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <p class="help-block">Nếu <i>Từ điền vào </i> là một trong các <i>Từ đúng</i> thì đáp án là ĐÚNG và ngược lại.</p>
                </div>
            </div>
            <div class="listaw">
                <?php
                foreach($_POST['question'] as $key=>$item){
                    ...
                    <div class="form-group" data-order="<?php echo $key?>">
                        ...
                        <div class="col-sm-2">
                            <input type="text" placeholder="Từ điền vào" name="question[<?php echo $key?>][fill]" class="form-control" value="<?php echo $item['fill'] ?>">
                        </div>
                        <div class="col-sm-2">
                            <input type="text" placeholder="Từ đúng, cách nhau bởi dấu |" name="question[<?php echo $key?>][aw]" class="form-control" value="<?php echo $item['aw'] ?>">
                        </div>
                        <div class="col-sm-1">
                            <a href="javascript:void(0)" onclick="$(this).parent().parent().remove();reindexlabel()">Xóa</a>
                        </div>
                    </div>
                <?php } ?>
            </div>
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            ...
            hoặc <a href="<?php echo cpagerparm("tact,id") ?>tact=np_ds_view">Thoát</a> |
...
<div>
    ...
    <img src="/admincp/asset/images/nguphap/nguphap_dungsai.png" alt="" style="display: none; border: 1px dashed #ccc" >
</div>
<script>
    $(function () {
...
//        console.log(lastOrder);return false;
        html = '<div class="form-group" data-order="'+next+'">'+
            ...
            '</div>'+
            '<div class="col-sm-2">'+
            '<input type="text" placeholder="Từ điền vào" name="question['+next+'][fill]" class="form-control">'+
            '</div>'+
            '<div class="col-sm-2">'+
            '<input type="text" placeholder="Từ đúng, cách nhau bởi dấu |" name="question['+next+'][aw]" class="form-control">'+
            '</div>'+
...
//            '<input type="text" placeholder="Link audio" name="question['+next+'][audio]" class="form-control">'+
//            '</div>'+
//            '<div class="col-sm-9 col-sm-offset-2" style="margin-top: 5px">'+
//            '<textarea name="question['+next+'][aw]" placeholder="Đáp án cách nhau bởi dấu | " class="form-control"></textarea>'+
//            '</div>'+
            '<div class="col-sm-1">'+
            '<a href="javascript:void(0)" onclick="$(this).parent().parent().remove();reindexlabel()">Xóa</a>'+
            '</div>'+
