<?php
$title = "Thông tin bài tập viết lại câu theo tranh - ngữ pháp";
...
<div class="text-left"><a href="<?php echo cpagerparm("tact,id") ?>tact=np_vlct_view ">Trở về danh sách bài tập</a></div>
...
if (isset($_POST['acpt'])) {
    ...
    if ($tact == "np_vlct_insert") {
        $_POST['_id'] = (string)strtotime("now");
        $_POST['datecreate'] = time();
        $_POST['type'] = "nguphap_vietlaicautranh";
...
##Get Data
if ($tact != "np_vlct_insert") $_POST = (array)$newscl->findOne(array("_id" => "$id"));
?>
<form class="form-horizontal" role="form" action="" method="post">
    <ul class="nav nav-tabs" role="tablist" id="myTab">
        <li class="active"><a href="#info" role="tab" data-toggle="tab">Thông tin bài tập viết lại câu theo tranh</a></li>
    </ul>
            ...
            <div class="listaw">
                ...
                foreach($_POST['question'] as $key=>$item){
                    ...
                    <div class="form-group" data-order="<?php echo $key?>">
                        ...
                        <div class="col-sm-2">
                            <input type="text" placeholder="Gợi ý" name="question[<?php echo $key?>][suggest]" class="form-control" value="<?php echo $item['suggest'] ?>">
                        </div>
                        <div class="col-sm-3">
                            <input type="text" placeholder="Đáp án, cách nhau bởi |" name="question[<?php echo $key?>][aw]" class="form-control" value="<?php echo $item['aw'] ?>">
                        </div>
                        <div class="col-sm-2">
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            ...
            hoặc <a href="<?php echo cpagerparm("tact,id") ?>tact=np_vlct_view">Thoát</a> |
...
//        console.log(lastOrder);return false;
        html = '<div class="form-group" data-order="'+next+'">'+
            ...
            '<div class="col-sm-2">'+
            '<input type="text" placeholder="Gợi ý" name="question['+next+'][suggest]" class="form-control">'+
            '</div>'+
            '<div class="col-sm-3">'+
            '<input type="text" placeholder="Đáp án, cách nhau bởi |" name="question['+next+'][aw]" class="form-control">'+
            '</div>'+
            '<div class="col-sm-2">'+
