<?php
$title = "Thông tin bài tập viết lại câu - ngữ pháp";
...
<div class="text-left"><a href="<?php echo cpagerparm("tact,id") ?>tact=np_vlc_view ">Trở về danh sách bài tập</a></div>
...
##Get Data
if ($tact != "np_vlc_insert") $_POST = (array)$newscl->findOne(array("_id" => "$id"));
?>
<form class="form-horizontal" role="form" action="" method="post">
    <ul class="nav nav-tabs" role="tablist" id="myTab">
        <li class="active"><a href="#info" role="tab" data-toggle="tab">Thông tin bài tập viết lại câu</a></li>
    </ul>
        ...
        <div class="tab-pane active" id="info">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <p class="help-block">Phần gợi ý và đáp án mỗi câu 1 dòng, viết cách nhau bởi dấu | (có thể có nhiều đáp án cách nhau bởi |)</p>
                    <p class="help-block">Ví dụ: <i>When/it/start/snowing|When does it start snowing?</i></p>
                </div>
                ...
                foreach($_POST['question'] as $key=>$item){
                    ...
                    <div class="form-group" data-order="<?php echo $key?>">
                        ...
                        <div class="col-sm-7 col-sm-offset-2" style="margin-top: 5px">
                            <textarea name="question[<?php echo $key?>][aw]" placeholder="Mỗi câu 1 dòng, gợi ý và đáp án cách nhau bởi dấu |" class="form-control"><?php echo $item['aw'] ?></textarea>
                        </div>
                        <div class="col-sm-2">
                            <textarea name="question[<?php echo $key?>][awaudio]" placeholder="Mỗi audio 1 dòng" class="form-control"><?php echo $item['awaudio'] ?></textarea>
                        </div>
                        <div class="col-sm-1">
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            ...
            hoặc <a href="<?php echo cpagerparm("tact,id") ?>tact=np_vlc_view">Thoát</a> |
...
//        console.log(lastOrder);return false;
        html = '<div class="form-group" data-order="'+next+'">'+
            ...
            '</div>'+
            '<div class="col-sm-7 col-sm-offset-2" style="margin-top: 5px">'+
            '<textarea name="question['+next+'][aw]" placeholder="Gợi ý và Đáp án cách nhau bởi dấu | " class="form-control"></textarea>'+
            '</div>'+
            '<div class="col-sm-2">'+
            '<textarea name="question['+next+'][awaudio]" placeholder="Mỗi audio 1 dòng" class="form-control"></textarea>'+
            '</div>'+
            '<div class="col-sm-1">'+
            '<a href="javascript:void(0)" onclick="$(this).parent().parent().remove()">Xóa</a>'+
            '</div>'+
