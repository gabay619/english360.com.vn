<?php
$title = "Quản lý bài tập viết lại câu theo tranh - ngữ pháp";
...
$limit = 25;
//$cond = array();
$cond = array('npid'=>$npid,'type'=>'nguphap_vietlaicautranh');
//$cond['type'] = $type;
$sort = array("_id" => -1);
...
<div class="text-right row">
    <div class="col-xs-3 text-left">
        ...
        <?php if(acceptpermiss("nguphap_test_insert")) { ?><a href="<?php echo cpagerparm("tact,id,status") ?>tact=np_vlct_insert"> | Thêm bài tập viết lại câu theo tranh</a><?php }?>
    </div>
    ...
    <table class="table table-hover">
        ...
        <?php foreach ($listnews as $item) { ?>
            <tr>
                ...
                <td>
                    <?php if(acceptpermiss("nguphap_test_update")) { ?><a href="<?php echo cpagerparm("tact,status,id") ?>tact=np_vlct_update&id=<?php echo $item['_id'] ?>">Sửa</a> |<?php }?>
