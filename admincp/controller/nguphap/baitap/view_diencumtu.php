<?php
$title = "Quản lý bài tập điền cụm từ - ngữ pháp";
...
$limit = 25;
//$cond = array();
$cond = array('npid'=>$npid,'type'=>'nguphap_diencumtu');
//$cond['type'] = $type;
$sort = array("_id" => -1);
...
<div class="text-right row">
    <div class="col-xs-3 text-left">
        ...
        <?php if(acceptpermiss("nguphap_test_insert")) { ?><a href="<?php echo cpagerparm("tact,id,status") ?>tact=np_dct_insert"> | Thêm bài tập điền cụm từ</a><?php }?>
    </div>
    ...
    <table class="table table-hover">
        ...
        <?php foreach ($listnews as $item) { ?>
            <tr>
                ...
                <td>
                    <?php if(acceptpermiss("nguphap_test_update")) { ?><a href="<?php echo cpagerparm("tact,status,id") ?>tact=np_dct_update&id=<?php echo $item['_id'] ?>">Sửa</a> |<?php }?>
