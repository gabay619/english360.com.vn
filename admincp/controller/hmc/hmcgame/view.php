...
<?php include "component/message.php"; ?>
    ...
    <form action="<?php echo cpagerparm("tact,id,status") ?>tact=hmcgame_delete" method="post">
        <table class="table table-hover">
            ...
            <?php foreach ($listnews as $item) {
                ...
                <tr>
                    ...
                    <td>Level <?php echo $item['level'] ?> - <?php echo Common::getAllGameDegree()[$item['degree']]?>
<!--                        <p ></p>-->
                    </td>
                    <td>
                        <ul>
                    ...
                    <td>
                        ...
                        <?php if(acceptpermiss("hmcgame_delete")) { ?><a onclick="return confirm('Bạn chắc chắn chứ?')" href="<?php echo cpagerparm("tact,status,id") ?>tact=hmcgame_delete&id=<?php echo $item['_id'] ?>">Xóa</a><?php }?>
                    </td>
                </tr>
            <?php } ?>
            </tbody>
