...
<form class="form-horizontal" role="form" action="" method="post">
    <ul class="nav nav-tabs" role="tablist" id="myTab">
        <li class="active"><a href="#info" role="tab" data-toggle="tab">Thông tin Tin tức</a></li>
        <li><a href="#category" role="tab" data-toggle="tab">Chuyên mục</a></li>
        <li><a href="#slideshow" role="tab" data-toggle="tab">Thông tin trên slideshow</a></li>
    </ul>
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="info">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="name" class="form-control" value="<?php echo $_POST['name'] ?>" placeholder="Ví dụ: Hot girl ABC bị ngã rách áo">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <label>
                        <input type="radio" class="col-sm-1" <?php echo !empty($_POST['isstatus']) && $_POST['isstatus'] == 'hot' ? 'checked' : ''; ?> value="hot" name="isstatus" />&nbsp;Tin Hot
                    </label> |
                    <label>
                        <input type="radio" <?php echo empty($_POST['isstatus']) || $_POST['isstatus'] == 'none' ? 'checked' : ''; ?> class="col-sm-1" value="none" name="isstatus" /> &nbsp;Tin thường
                    </label>
                </div>
            </div>
            <div class="form-group">
        ...
        <div class="tab-pane" id="slideshow">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label">Nhãn</label>

                <div class="col-sm-10">
                    <input type="text" name="slidekey" class="form-control" value="<?php echo $_POST['slidekey'] ?>" placeholder="Tin hot">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="slidename" class="form-control" value="<?php echo $_POST['slidename'] ?>" placeholder="Ví dụ: Tin tực sốc của bé gái 60 tuổi bị ngã gãy răng">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">Mô tả ngắn</label>
                ...
                <div class="col-sm-10">
                    <input type="text" name="slidecaptions" class="form-control" value="<?php echo $_POST['slidecaptions'] ?>" placeholder="Một vài mô tả...">
                </div>
            </div>
            <div class="form-group">
                <input type="hidden" name="slideavatar" id="slideavatar" value="<?php echo $_POST['slideavatar'] ?>" />
                <label class="col-sm-2 control-label">Ảnh cỡ lớn - Slideshow avatar</label>

                <div class="col-sm-10">
                    <input type="file" name="file_upload" id="file_upload2" />

                    <p>
                        <img src="<?php echo $_POST['slideavatar'] ?>" id="previewavatarsl" style="max-width: 350px;display:<?php echo strlen($_POST['slideavatar']) > 0 ? "block" : "none"; ?>" />
                    </p>

                    <p class="help-block">Chọn ảnh PNG, JPG, JPEG, GIF (chiều cao ảnh khuyến khích: 615px)</p>
                </div>
            </div>
        </div>
    </div>
