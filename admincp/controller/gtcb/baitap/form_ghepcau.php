<?php
$title = "Thông tin bài tập ghép câu - giao tiếp cơ bản";
...
##Get Data
if ($tact != "gtcb_gc_insert") $_POST = (array)$newscl->findOne(array("_id" => "$id"));
?>
<form class="form-horizontal" role="form" action="" method="post">
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="info">
            ...
            <input type="hidden" name="type" value="gtcb_ghepcau">
            <div class="form-group">
           ...
           <!-- <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-20"><a href="javascript:void(0)" onclick="addAnswer()">Thêm đoạn hội thoại</a></div>
            </div>
            <div class="listaw">
                <div class="form-group">
                    <?php
                    ...
                    <div class="col-sm-4">
                   <input type="text" name="aw[]" class="form-control" value="<?php echo $_POST['aw'][$i] ?>">
                   </div>

                   <div class="col-sm-4">
                        <input type="text" name="ax[]" class="form-control" value="<?php echo $_POST['ax'][$i] ?>">
                    </div>

                    <div class="col-sm-1">
                        <input type="text" name="true[]" class="form-control" value="<?php echo $_POST['true'][$i]?>">
                    </div>
