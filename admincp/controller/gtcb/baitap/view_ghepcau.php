<?php
$title = "Quản lý bài tập ghép câu - Giao tiếp cơ bản";
...
$cond['gtcbid'] = $gtcbid;
$cond['type'] = $type;
$type = array('gtcbid'=>$gtcbid,'type'=>'gtcb_ghepcau');
$sort = array("_id" => -1);
...
<div class="text-right row">
    <div class="col-xs-3 text-left">
        ...
        <?php if(acceptpermiss("gtcb_gc_insert")) { ?><a href="<?php echo cpagerparm("tact,id,status") ?>tact=gtcb_gc_insert">  Thêm mới</a><?php }?>
    </div>
    ...
    <table class="table table-hover">
        ...
        <?php foreach ($listnews as $item) { ?>
            ...
            <tr>
                ...
                <td>
                    <?php if(acceptpermiss("gtcb_test_update")) { ?><a href="<?php echo cpagerparm("tact,status,id") ?>tact=gtcb_gc_update&id=<?php echo $item['_id'] ?>">Sửa</a> |<?php }?>
